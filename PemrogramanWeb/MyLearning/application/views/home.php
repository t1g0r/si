...
<head>
  ...
  <link  href="<?php echo base_url('assets/bower_components/font-awesome/css/font-awesome.min.css'); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/Ionicons/css/ionicons.min.css'); ?>" rel="stylesheet" type="text/css">
...
<div class="wrapper">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>UMB</b></span>
    </a>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
						<li class="fa fa-circle-o" onclick="javascript:location.href='<?php echo base_url('hello'); ?>'">
                <a href="#">&nbsp;&nbsp;<i class="fa fa-circle-o"></i> <span>Hello</span></a>
            </li>
          </ul>
        </li>
        <li class="treeview">
