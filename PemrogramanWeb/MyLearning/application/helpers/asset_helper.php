...
if ( ! function_exists('avatar_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('avatar_path');
    }
}
 ...
 * @return  string
 */
if ( ! function_exists('component_url'))
{
    function component_url()
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('component_path');
    }
}
...
if ( ! function_exists('static_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('static_path');
    }
}
